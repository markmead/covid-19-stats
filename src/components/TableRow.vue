<template>
  ...
  >
    ...
    <td
      class="px-6 py-4 text-sm leading-none text-gray-500 whitespace-no-wrap transition ease-in-out dark:text-gray-200 duration hover:text-indigo-600 dark-hover:text-white"
    >
