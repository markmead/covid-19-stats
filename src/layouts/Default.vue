      ...
      <div class="fixed inset-0 flex z-40">
        <div v-show="sidebarOpen">
          ...
          <div class="flex-shrink-0 flex items-center px-4">
            <g-image class="h-8 w-auto" src="~/workflow-logo-on-white.svg" alt="Workflow" />
          </div>
          <div class="mt-5 flex-1 h-0 overflow-y-auto">
            <nav class="px-2">
              ...
              <g-link to="/reports" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-100 transition ease-in-out duration-150">
      ...
      <div class="flex flex-col w-64 border-r border-gray-200 pt-5 pb-4 bg-white">
        ...
        <div class="mt-5 h-0 flex-1 flex flex-col overflow-y-auto">
          ...
          <nav class="flex-1 px-2 bg-white">
            ...
            <g-link to="/reports" class="mt-1 group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-100 transition ease-in-out duration-150">
